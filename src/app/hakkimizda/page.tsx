...
const structuredData = {
  ...
  breadcrumb: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Hakkımızda', item: 'https://futboltrivia.com.tr/hakkimizda' },
    ],
  },
};
      ...
      <div className="min-h-screen bg-slate-950 text-slate-300 font-sans selection:bg-red-900/40">
        <div className="max-w-2xl mx-auto px-6 py-10 flex flex-col">
          ...
          <header className="mb-12">
            <p className="text-xs text-red-600 tracking-wide font-medium mb-3">Platform</p>
          ...
          <div className="space-y-10 text-base leading-relaxed font-light">
            ...
            <section aria-labelledby="veri">
              ...
              <p>Oyunlar her gün yenilenir. Dünün sorusunu cevaplamak isteyenler için arşiv erişimi mevcuttur.</p>
            </section>
            ...
            <section aria-labelledby="iletisim-hakkimizda">
              <h2 id="iletisim-hakkimizda" className="flex items-start gap-3 text-white font-normal text-lg mb-4 leading-snug">
                <span className="mt-1 shrink-0 w-0.5 h-5 bg-red-600 rounded-full" aria-hidden="true" />
                İletişim
              </h2>
