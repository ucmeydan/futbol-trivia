...
export default function Iletisim() {
  return (
    <div className="max-w-2xl mx-auto p-6 text-slate-300 font-sans min-h-screen flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="mb-8">
      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="pt-8 border-t border-slate-800/50 relative z-10">
          {/* GÜNCELLENEN KISIM: Uppercase kaldırıldı ve font zarifleştirildi */}
          <h2 className="text-red-600 font-light text-sm mb-3 tracking-tight">
            E-posta Adresimiz
          </h2>
          <a 
            href="mailto:futboltriviatr@gmail.com" 
            className="text-2xl font-light text-white hover:text-red-500 transition-all break-all underline decoration-red-600/20 underline-offset-8"
          >
      ...
      <div className="mt-auto pt-12 pb-6 text-center text-slate-700">
